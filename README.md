#GryffindorElites Mentor - Bento grid
...
2. Configure your repository to publish your code to a web address. This will also be useful,
...
Submit your solution on the Google Classroom platform for the Mentor to View and Evaluate It. 
What to Submit :
- Mobile View ScreenShot
- Desktob View ScreenShot
- Project Repo link
- Github Pages link 
